...
namespace CliKit
{
	...
	{
		public static void EmitLoad(this ILGenerator generator, LocalLocation location)
		{
		...
		public static void EmitLoadAddress(this ILGenerator generator, LocalLocation location)
		{
			Contract.Requires(generator != null);
		...
		public static void EmitStore(this ILGenerator generator, LocalLocation location)
		{
			Contract.Requires(generator != null);
