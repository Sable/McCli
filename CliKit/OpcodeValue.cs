...
{
	/// <summary>
	/// Provides the numeric values of the opcodes, in big-endian format.
	/// </summary>
	public enum OpcodeValue : ushort
	{
		...
		Ldind_U8 = Ldind_I8,
		Ldelem_U8 = Ldelem_I8,
		// Ldc_I4_M1x = Ldc_I4_M1, <-- oddity present in the standard
		Endfault = Endfinally,
	}

	/// <summary>
	/// Provides utility methods for dealing with the <see cref="OpcodeValue"/> enumeration.
	/// </summary>
	public static class OpcodeValueEnum
	{
		[Pure]
		public static bool IsFirstOfTwoBytes(byte value)
		{
			return value == 0xFE;
		}
